...
import 'package:injectable_generator_micropackages/dependency_config.dart';
import 'package:injectable_generator_micropackages/generator/factory_param_generator.dart';
import 'package:injectable_generator_micropackages/generator/module_factory_generator.dart';
import 'package:injectable_generator_micropackages/generator/singleton_generator.dart';
import 'package:injectable_generator_micropackages/injectable_types.dart';
...
class ConfigCodeGenerator {
  ...
  FutureOr<String> generate() async {
    ...
    final environments = sorted.fold(<String>{}, (dynamic prev, elm) => prev..addAll(elm.environments));
