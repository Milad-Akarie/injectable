...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.lazySingleton<_i978.ModelC>(() => _i978.ModelC.from());
    gh.lazySingleton<_i978.ModelW>(() => _i978.ModelW.from(gh<String>()));
    gh.factoryParam<_i978.IService, String?, dynamic>(
      (
        param,
        _,
      ) =>
          _i978.ServiceImpl.new(param),
    ...
    gh.lazySingleton<_i978.ModelZ>(() => _i978.ModelZ.from(gh<_i978.ModelW>()));
    gh.lazySingletonAsync<_i253.Repo>(
      () => registerModule
          .getRepo(gh<_i978.IService>(instanceName: 'ServiceImpl')),
      instanceName: 'Repo',
      registerFor: {_dev},
      dispose: _i253.disposeRepo,
    );
    gh.singletonAsync<_i978.PostConstructableService>(() {
      final i = _i978.PostConstructableService.new(gh<_i978.IService>());
